...
<%
    // Recupera o objeto Professor da session
    Professor professor = (Professor) session.getAttribute("professor");
    System.out.println("Professor logado : "+professor.getEmail());
    
    if (professor == null) {
        // Se não estiver logado, redireciona para login
        response.sendRedirect("../../login.jsp");
        System.out.println("Professor não cadastrado ou credenciais invalidas");
        return;
    }
%>
...
<html lang="pt-BR">
    ...
    <body class="font-sans bg-gray-50">
        ...
        <header class="bg-white shadow-md sticky top-0 z-50">
            <div class="container mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <nav class="hidden md:flex space-x-8">
                    ...
                    <a href="javascript:void(0)" onclick="loadIframe('list_turmas.jsp')" class="text-gray-700 hover:text-indigo-600meus_cursos.jsp font-medium">Turmas</a>
        ...
        <iframe id="contentFrame" class="content-iframe" src="frame.jsp" name="contentFrame"></iframe>
        ...
        <script>
            ...
            window.onload = function() {
                document.getElementById('contentFrame').src = 'frame.jsp';
            };
        </script>
    </body>
</html>