    ...
    <body class="bg-gray-100 min-h-screen flex flex-col">
        ...
        <main class="flex-grow container mx-auto px-4 py-8 max-w-7xl">
            <%
                ...
                List<Aluno> lista = alu.consultar_lista_simples();
            %>

            <!-- Título -->
            <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6">
                <div class="bg-indigo-600 px-6 py-4 text-white">
                    <h2 class="text-2xl font-bold">Lista Geral de Alunos</h2>
                </div>
            </div>

            <!-- Tabela -->
            <div class="bg-white rounded-xl shadow-md p-6">
                <h5 class="text-indigo-700 font-medium mb-4">Todos os alunos cadastrados:</h5>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-indigo-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-indigo-800 uppercase tracking-wider">Matrícula</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-indigo-50 transition duration-150">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-700"><%= lista.get(i).getMatricula()%></td>
                                <td class="px-6 py-4 text-sm">
                                    <a href="../../../components/buttons/btn_edit_aluno.jsp?id=<%= lista.get(i).getId()%>" class="text-indigo-600 hover:text-indigo-800 mr-3" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                </td>
                                <td class="px-6 py-4 text-sm">
                                    <a href="../../../components/buttons/btn_cons_aluno.jsp?id=<%= lista.get(i).getId()%>" class="text-indigo-600 hover:text-indigo-800 mr-3" title="Consultar">
                                        <i class="fas fa-search"></i>
                                    </a>
                                </td>
                                <td class="px-6 py-4 text-sm">
                                    <a href="../../../components/buttons/btn_dell_aluno.jsp?id=<%= lista.get(i).getId()%>" class="text-red-600 hover:text-red-800" title="Excluir"
