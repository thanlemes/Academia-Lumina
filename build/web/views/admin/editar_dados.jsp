...
<div class="bg-white rounded-2xl shadow-lg w-full max-w-3xl p-10 space-y-6">
    ...
    <%
        ...
        if (userdao.consultar_por_id(usuario) != null) {
            System.out.println(usuario.getTipo());
    %>
    <form method="post" action="../../components/operations/atualizar_dados_user.jsp" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
        ...
        <div>
            ...
            <input type="text" name="nome" value="<%= usuario.getUsuario()%>" required
        ...
        <div>
            ...
            <input type="text" name="telefone" value="<%= usuario.getTelefone()%>" required
                   class="mt-1 w-full border border-blue-300 rounded-lg p-3 focus:ring-2 focus:ring-blue-500" />
        </div>
