...
<%
    // Recupera o objeto Usuario da session
    Usuarios usuario = (Usuarios) session.getAttribute("usuario");
    System.out.println("Usuario logado : " + usuario.getTipo());
        ...
        <header class="bg-white shadow-md sticky top-0 z-50">
            <div class="container mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <nav class="hidden md:flex space-x-8">
                    ...
                    <a href="javascript:void(0)" onclick="loadIframe('painel_administrativo.jsp')" class="text-gray-700 hover:text-indigo-600 font-medium">Painel administrativo</a>
