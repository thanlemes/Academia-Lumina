...
<html lang="pt-BR">
    ...
    <div class="container mx-auto px-4 py-4 flex justify-between items-center"> <!-- Alterado de py-3 para py-4 -->
        ...
        <nav class="hidden md:flex space-x-8">
            ...
            <a href="#cursos" class="text-gray-700 hover:text-indigo-600 font-medium">Cursos</a>
            <a href="#eventos" class="text-gray-700 hover:text-indigo-600 font-medium">Eventos</a>
            <a href="#contato" class="text-gray-700 hover:text-indigo-600 font-medium">Contato</a>
