...
<body class="bg-blue-100 min-h-screen flex items-center justify-center p-6">
    <div class="bg-white rounded-2xl shadow-lg w-full max-w-2xl p-10 space-y-6">
        <div class="border-b border-blue-200 pb-4 mb-6">
            ...
            <p class="text-sm text-blue-600">Preencha os dados abaixo para cadastrar um novo professor.</p>
        </div>

        <form action="../operations/inserir_prof.jsp" method="post" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
            ...
            <div class="md:col-span-2 flex justify-end space-x-4">
                <button type="submit"
                    ...
                    <i class="fas fa-paper-plane mr-2"></i> Cadastrar Professor
                </button>
