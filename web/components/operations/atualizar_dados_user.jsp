    ...
    <body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
        ...
        <div class="bg-white shadow-2xl rounded-2xl p-10 max-w-xl w-full text-center">
            ...
            <div class="text-lg font-medium text-gray-800">
                <%
                    if (atualizado) {
                        Usuarios usuarioAtualizado = usuariosDAO.consultar_por_id(user);
            ...
            <div class="mt-6">
                <a href="../../views/admin/dados_pessoais.jsp" class="inline-block bg-blue-600 text-white px-6 py-2 rounded-xl shadow hover:bg-blue-700 transition">
                    Voltar
                </a>
            </div>
        </div>
